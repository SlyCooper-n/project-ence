import { Button, Container, Head, Heading, Input, Text } from "@/components";
...
export const Budget = () => {
  ...
  return (
    <>
      <Head title={isInEnglish ? "Budget" : "Orçamento"} />
      ...
      <div className="mx-auto flex min-h-[calc(100vh-115px)] max-w-[1920px]">
        ...
        >
          <main>
            ...
            <Text
              asChild
              className="mb-20 max-w-[500px] text-center md:text-xl"
            >
              <p>
                {isInEnglish ? (
                  <>
            ...
            <form
              action=""
              className="flex w-full max-w-[500px] flex-col gap-9"
            >
              <Input.Root>
